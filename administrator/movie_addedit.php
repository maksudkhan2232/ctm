...
<?php 
    if($_SESSION['user_session_right']=='administrator'){
      if(isset($_REQUEST['movie_add'])){
        ...
        $res=$db->query_insert('movie',$data_movie);
        if($res!=''){
           echo "<script>window.location.href = 'movie_list.php?recordmsg=successadd';</script>";
        }           
    }
?>
      ...
      <div class="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6">
              <div class="mt-5">
                <h5 class="font-14">Add New Movie</h5>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="mt-5">
            ...
            <div class="col-lg-6">
              <form class="form-horizontal" method="post">
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <div class="input-group">
                      ...
                      <input type="text" id="moviename" name="moviename" class="form-control" placeholder="Enter Movie Name">
                    </div>
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <div class="input-group">
                      ...
                      <input type="date" id="release_date" name="release_date" class="form-control" placeholder="Enter Release Date">
                    </div>
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="row d-flex justify-content-center mt-5"> 
                  ...
                  <button type="submit" class="btn btn-primary btn-lg btn-bordered-primary" name="movie_add">Submit</button>
                </div>
              </form>
            </div>
          </div>
