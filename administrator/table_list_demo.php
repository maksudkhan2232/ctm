        ...
        <div class="content">
          ...
          <div class="container-fluid">
            <div class="row d-flex justify-content-center">
              ...
              <div class="col-lg-6">
                <div class="mt-5">
                  <p style="float:right"> <a href="" class="btn btn-danger btn-rounded">Add New Movie</A> </p>
                </div>
              </div>
            </div>
            <div class="row d-flex justify-content-center">
                ...
                <table id="responsive-datatable" class="table table-bordered table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><a href="" class="btn btn-primary btn-sm  mr-1">Edit</a> <a href="" class="btn btn-danger btn-sm  mr-1">Delete</a> <a href="" class="btn btn-icon btn-danger btn-sm"> <i class="fas fa-times"></i> </a> </td>
                    </tr>
                    <tr>
